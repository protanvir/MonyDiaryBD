...
class $AccountsTable extends Accounts with TableInfo<$AccountsTable, Account> {
  ...
  static const VerificationMeta _cardNetworkMeta = const VerificationMeta(
    'cardNetwork',
  );
  @override
  ...
  Account map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Account(
      ...
      cardNetwork: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}card_network'],
      ),
    );
  }
...
class Account extends DataClass implements Insertable<Account> {
  ...
  Account copyWithCompanion(AccountsCompanion data) {
    return Account(
      ...
      cardNetwork: data.cardNetwork.present
          ? data.cardNetwork.value
          : this.cardNetwork,
    );
  }
...
class $CategoriesTable extends Categories
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, type, iconName];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Category extends DataClass implements Insertable<Category> {
  ...
  @override
  int get hashCode => Object.hash(id, name, type, iconName);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Category &&
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, amount, date, categoryId, accountId, note);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
